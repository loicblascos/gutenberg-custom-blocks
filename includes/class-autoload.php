 ...
 * Autoloader
 *
 * Modification of psr4-autoloader to be compliant with WordPress file names ("class-" prefix).
 *
 ...
 * Autoload class.
 *
 * @class Gutenberg_Custom_Blocks\Autoload
 * @since 1.0.0
 */
class Autoload {
...
$loader = new \Gutenberg_Custom_Blocks\Autoload();
// Register the base directories for the namespace prefix.
$loader->add_namespace( 'Gutenberg_Custom_Blocks', GCB_PATH );
